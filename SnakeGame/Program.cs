...
namespace SnakeGame
{
    class Program
    {
        ...
        private const int ScreenWidrh = MapWidth * 3;
        ...
        static void Main()
        {
            SetWindowSize(ScreenWidrh, ScreenHeight);
            SetBufferSize(ScreenWidrh, ScreenHeight);
            CursorVisible = false;
        ...
        static void StartGame()
        {
            ...
            SetCursorPosition(ScreenWidrh / 3, ScreenHeight / 2);
